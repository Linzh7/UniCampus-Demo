...
class LoginUtil {
  ...
  //   Dio loginDio = Dio();
  //   var loginResult = await loginDio.post(Login_URL, queryParameters: {"username": username,"password": password});
  //   if(loginResult.data['status']!=200){
  //     LogUtil.e("[Login] Error: ${loginResult.data["msg"]}");
  //     return int.parse(loginResult.data['status']);
  //   }else{
  //     Settings.token=loginResult.data["obj"];
  //     SharedPreferences sp = await SharedPreferences.getInstance();
  //     sp.setString("token", loginResult.data["obj"]);
  //     return 0;
  //   }
  // }
